        ...
        <form action="{{ route('usuarios.store') }}" method="POST" class="user-form">
            ...
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    ...
                    <input type="text" name="usuario" class="form-input" value="{{ old('usuario') }}" placeholder="Ingrese el nombre de usuario" required>
                </div>
            </div>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('productos.index') }}" class="cancel-button">
