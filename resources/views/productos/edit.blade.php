<form action="{{ route('productos.update', $producto->id) }}" method="POST" enctype="multipart/form-data" class="product-form">
    ...
    <div class="form-row">
        <div class="form-group half-width">
            ...
            <div class="input-with-symbol">
                ...
                <input type="number" step="0.01" name="precio" value="{{ old('precio', $producto->precio) }}" class="form-input" required>
            </div>
        </div>

        <div class="form-group half-width">
            <label class="form-label">Stock:</label>
            <input type="number" name="stock" value="{{ old('stock', $producto->stock) }}" class="form-input" required>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="current-image">
            @if($producto->imagen)
                <img src="{{ asset('storage/'.$producto->imagen) }}" class="product-image">
            @else
